...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:8080/api/v1/vnpay/payment/return";
    public static String vnp_TmnCode = "FZJXO026";
    public static String vnp_HashSecret = "OLKNSRAXPJCHACQGLUGJFCCJZUTUBSCR";
    public static String vnp_apiUrl = "https://sandbox.vnpayment.vn/merchant_webapi/merchant.html";
    public static int order_type = 190000;
